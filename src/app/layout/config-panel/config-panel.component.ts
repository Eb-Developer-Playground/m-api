...
import {
  Theme,
  ThemeService,
} from '../../../@equity-bank/services/theme.service';

@Component({
  selector: 'equity-bank-config-panel',
  templateUrl: './config-panel.component.html',
  styleUrls: ['./config-panel.component.scss'],
})
export class ConfigPanelComponent implements OnInit {
  activeTheme$ = this.themeService.activeTheme$;
  navigation$ = this.themeService.config$.pipe(
  ...
  footerVisible$ = this.themeService.config$.pipe(
